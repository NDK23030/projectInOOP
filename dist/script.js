...
/*#__PURE__*/
function () {
  function Accordion(headSelector) {
    ...
    value: function bindTriggers(container, items, counter) {
      container.querySelector('.plus').addEventListener('click', function () {
        if (counter !== items.length - 2) {
          ...
          items[counter].style.display = 'flex';
          items[items.length - 1].classList.add('fadeOut');
...
function () {
  function Download(triggers) {
    ...
    this.path = 'assets/img/mainbg.jgp';
  }
...
function (_Slider) {
  ...
  function SliderMain(btns, prevModule, nextModule) {
    _classCallCheck(this, SliderMain);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMain).call(this, btns, prevModule, nextModule));
  }
